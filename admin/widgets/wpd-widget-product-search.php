...
class WP_Dispensary_Product_Search_Widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
            ...
            esc_html__( 'Product Search', 'cannabiz-menu' ),
            array(
                'description' => esc_html__( 'Add a search box', 'cannabiz-menu' ),
        ...
        echo '<div class="wp-dispensary-product-search">' . 
            ...
            do_action( 'wpd_product_search_widget_before_form' ) . 
                ...
                '<form role="search" action="' . site_url( '/' ) . '" method="get" id="searchform">
                    <input type="text" name="s" placeholder="' . esc_html__( 'Search Products', 'cannabiz-menu' ) . '" />
                    <input type="hidden" name="post_type" value="products" />
                    <input type="submit" alt="Search" value="' . esc_html__( 'Search', 'cannabiz-menu' ) . '" />
                </form>' . 
